    ...
    <div className="space-y-8">
      ...
      <div className="leading-7">
        <p>
          ...
          guide shows you how to use the application and{' '}
          <Link
          ...
          covers specific options, this section explains the underlying concepts
          and design principles of the workflow builder. Understanding these
          concepts will help you make better decisions when creating your
          workflows.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground">
          How your workflow selections are transformed into ready-to-use GitHub
          Actions workflows
        </p>
        ...
        <div className="space-y-3 rounded-lg border p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                You provide workflow details through the web app's intuitive
                form interface
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                The web app applies your selections to the appropriate workflow
                template
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                You see your workflow YAML update instantly as you make
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Required secrets are automatically identified based on your
                configuration choices
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                You download the final YAML file ready to use in your GitHub
                repository
              </p>
            </div>
          </div>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-4">
          <p>
            Workflow presets are ready-to-use templates tailored for specific
            CI/CD needs. Each preset:
          </p>
          ...
          <p className="mt-2">Currently available presets include:</p>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-4">
          <p>The web app provides an intuitive configuration interface that:</p>
          ...
          <div className="rounded-lg border bg-muted/30 p-4">
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-2">
              ...
              <div className="rounded-lg bg-muted/50 p-3">
                <p className="text-sm font-medium">Trigger Options</p>
                <ul className="ml-4 mt-1 list-disc space-y-1 text-xs">
          ...
          <p>
            ...
            for detailed documentation of all available options.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground">
          The workflow generator outputs YAML files compatible with GitHub
          Actions
        </p>

        <div className="space-y-4">
          <p>
            The workflows you create are ready to use with GitHub Actions
          ...
          <div className="rounded-lg border bg-muted/30 p-4">
            <h4 className="mb-2 font-semibold">Using Your Workflow</h4>
            <ol className="ml-4 list-decimal space-y-2 text-sm">
              <li>Download the YAML file from the web app</li>
              <li>
                Add it to the <code>.github/workflows</code> directory in your
                repository
              </li>
              <li>Commit and push to your GitHub repository</li>
              <li>
                GitHub will automatically run your workflow based on the
                triggers you configured
              </li>
      ...
      <section className="space-y-4">
        <h2
          className="text-2xl font-semibold tracking-tight"
          id="workflows-in-action"
        >
          Workflows in Action
        </h2>
        <p className="text-muted-foreground">
          How your generated workflows help streamline your React Native
          development process
        </p>

        <div className="space-y-4">
          <p>
            The workflows you create deliver tangible benefits to your
            development process:
          </p>

          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border p-4">
              <h3 className="mb-2 font-medium">Code Quality Assurance</h3>
            ...
            <div className="rounded-lg border p-4">
              <h3 className="mb-2 font-medium">Efficient Build Process</h3>
              <ul className="ml-4 list-disc space-y-1 text-sm">
          ...
          <div className="mt-4 rounded-lg bg-muted/30 p-4">
            <h4 className="mb-2 font-semibold">Continuous Improvement</h4>
            <p className="text-sm">
              We're constantly adding new features and improvements to our
              workflow templates based on industry best practices and user
              feedback. Check back regularly for updates that can further
