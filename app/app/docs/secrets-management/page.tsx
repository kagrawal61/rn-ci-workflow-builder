    ...
    <div className="space-y-8">
      ...
      <div>
        <p className="leading-7">
          CI/CD workflows often require access to sensitive information such as
          API keys, signing certificates, and deployment credentials. This guide
          explains how to securely manage these secrets in your workflow
          configurations.
        </p>
      </div>
      ...
      <section className="space-y-6">
        ...
        <p className="leading-7">
          Secrets are sensitive values that should never be committed to your
          repository but are required for your CI/CD workflows. These include
          API keys, signing keys, access tokens, and other credentials.
        </p>
        ...
        <div className="space-y-4">
          ...
          <ul className="ml-6 list-disc space-y-2">
            ...
            <li>
              Allows different team members to run workflows without sharing
              credentials
            </li>
            <li>
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          GitHub Actions provides a secure way to store sensitive information as
          secrets
        </p>
        ...
        <div className="space-y-4">
          ...
          <ul className="ml-6 list-disc space-y-2">
            <li>
              Secrets are encrypted environment variables stored in your GitHub
              repository
            </li>
        ...
        <div className="space-y-4">
          ...
          <p className="mt-2 text-sm">
            ...
            >
              GitHub Actions encrypted secrets documentation
            </a>
            .
          </p>
        </div>
        ...
        <div className="rounded-lg border p-4">
          ...
          <ul className="ml-4 mt-2 list-disc space-y-1 text-sm">
            <li>
              <code>ANDROID_KEYSTORE_BASE64</code>: Android signing keystore
              (Base64 encoded)
            </li>
            <li>
              <code>ANDROID_KEYSTORE_PASSWORD</code>: Android keystore password
            </li>
            <li>
              <code>ANDROID_KEY_ALIAS</code>: Android signing key alias
            </li>
            <li>
              <code>ANDROID_KEY_PASSWORD</code>: Android signing key password
            </li>
            <li>
              <code>IOS_DISTRIBUTION_CERT_BASE64</code>: iOS distribution
              certificate (Base64 encoded)
            </li>
            <li>
              <code>IOS_PROVISIONING_PROFILE_BASE64</code>: iOS provisioning
              profile (Base64 encoded)
            </li>
            <li>
              <code>IOS_CERT_PASSWORD</code>: iOS certificate password
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          Bitrise provides multiple ways to securely manage sensitive
          information
        </p>
        ...
        <div className="space-y-4">
          ...
          <ul className="ml-6 list-disc space-y-2">
            <li>
              Secrets can be managed as Environment Variables with the
              "Sensitive" option enabled
            </li>
        ...
        <div className="space-y-4">
          ...
          <ol className="ml-6 list-decimal space-y-2">
            ...
            <li>
              Toggle "Expose for Pull Requests" only if needed (usually keep
              this off for sensitive values)
            </li>
          ...
          <p className="mt-2 text-sm">
            For more details, see the{' '}
            <a
              href="https://devcenter.bitrise.io/en/builds/secrets.html"
              className="text-blue-600 hover:underline"
              target="_blank"
              rel="noopener noreferrer"
            >
              Bitrise secrets documentation
            </a>
            .
          </p>
        </div>
          ...
          <div className="overflow-hidden rounded-lg border">
            <table className="w-full">
              ...
              <tbody>
                ...
                <tr className="border-t">
                  <td className="px-4 py-2 text-sm" rowSpan={2}>
                ...
                <tr className="border-t">
                  <td className="px-4 py-2 text-sm" rowSpan={3}>
                    Google Drive
                  </td>
                  <td className="px-4 py-2 font-mono text-xs">
            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                <tr className="border-t">
                  ...
                  <td className="px-4 py-2 text-sm">
                    Base64-encoded distribution certificate
                  </td>
                </tr>
                <tr className="border-t">
                  <td className="px-4 py-2 font-mono text-xs">
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-t">
                  ...
                  <td className="px-4 py-2 text-sm">
                    Webhook URL for posting to Slack channel
                  </td>
                </tr>
                <tr className="border-t">
                  ...
                  <td className="px-4 py-2 text-sm">
                    Webhook URL for posting to Teams channel
                  </td>
                </tr>
              </tbody>
            </table>
