...
export default function ConfigurationPage() {
    ...
    <div className="space-y-8">
      ...
      <div>
        <p className="leading-7">
          This section serves as a reference for the configuration options
          available in the web interface. Unlike the step-by-step guide in
          Getting Started, this page provides a comprehensive overview of all
          available settings and their impact on your generated workflows.
        </p>
        <p className="mt-4 leading-7">
          Each section below corresponds to a specific area in the web app
          configuration form, making it easy to find the options you need when
      ...
      <div className="mb-8 grid gap-4 md:grid-cols-2">
        <Card className="p-5">
          <h3 className="mb-2 font-semibold">Configuring in the Web App</h3>
          <p className="text-sm text-muted-foreground">
            The web app provides an intuitive form interface for all options,
            with:
          </p>
        ...
        <Card className="p-5">
          <h3 className="mb-2 font-semibold">Common Configuration Tasks</h3>
          <ul className="ml-4 mt-2 list-disc space-y-1 text-sm">
            <li>
              <Link
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-lg border p-4">
                ...
                <p className="mt-2 text-sm">
                  Default: "React Native Static Analysis" or "React Native
                  Build"
                </p>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-lg border p-4">
                ...
                <p className="mt-2 text-sm">
                  Location: Environment section in the web app
                </p>
              </div>
              ...
              <div className="rounded-lg border p-4">
                ...
                <p className="mt-2 text-sm">
                  Location: Advanced triggers section
                </p>
              </div>
      ...
      <section className="space-y-6" id="workflow-options">
        ...
        <p className="text-muted-foreground">
          Common configuration options available for all workflow types in the
          web app
        </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Start by selecting either "Static Analysis" or "Build" from
                    the dropdown menu at the top of the form. This determines
                    which workflow template will be used.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Enter a custom workflow name or use the default. Then
                    configure Node.js version(s) and package manager.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    In the "Triggers" section, select when the workflow should
                    run (on push, pull request, etc.) and specify which branches
                    should activate it.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Depending on your workflow type, configure additional
                    options like build platform or code quality checks.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-4">
              ...
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-t">
                    ...
                    <td className="px-4 py-2 text-sm">
                      Which Node.js version(s) to use
                    </td>
                  ...
                  <tr className="border-t">
                    <td className="px-4 py-2 text-sm font-medium">Runner</td>
                    <td className="px-4 py-2 text-sm">
            ...
            <div className="rounded-lg bg-muted/40 p-4">
              <h4 className="mb-2 font-semibold">Package Manager Tips</h4>
          ...
          <div className="space-y-4">
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-t">
                    ...
                    <td className="px-4 py-2 text-sm">
                      Add custom env vars as key-value pairs
                    </td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-4 py-2 text-sm font-medium">Secrets</td>
                    <td className="px-4 py-2 text-sm">
                      Add secret references required by your workflow
                    </td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-4 py-2 text-sm font-medium">
                    ...
                    <td className="px-4 py-2 text-sm">
                      Control caching for faster workflow runs
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="rounded-lg border p-4">
              <h4 className="mb-2 font-semibold">Working with Secrets</h4>
              <p className="text-sm text-muted-foreground">
                The web app will automatically detect required secrets based on
                your configuration (e.g., for signing Android builds or using
                Firebase). For details, see:
              </p>
              <p className="mt-3">
                <Link
        ...
        <div className="mt-8 rounded-lg border bg-muted/30 p-5">
          <h3 className="mb-2 font-semibold">Configuration Options Overview</h3>
          <p className="mb-4 text-sm text-muted-foreground">
            The web app provides a comprehensive set of options for customizing
            your workflow. These options are organized into logical sections in
            the interface for easy navigation and configuration.
          </p>
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="rounded-lg border p-3">
              <h4 className="text-sm font-medium">Triggers & Events</h4>
              <ul className="ml-4 mt-1 list-disc space-y-1 text-sm">
                <li>Push events</li>
            ...
            <div className="rounded-lg border p-3">
              <h4 className="text-sm font-medium">Environment & Secrets</h4>
              <ul className="ml-4 mt-1 list-disc space-y-1 text-sm">
            ...
            <div className="rounded-lg border p-3">
              <h4 className="text-sm font-medium">Workflow-Specific Options</h4>
              <ul className="ml-4 mt-1 list-disc space-y-1 text-sm">
          ...
          <div className="rounded-lg border p-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <ul className="ml-4 mt-2 list-disc space-y-1 text-sm">
                  <li>
                    <span className="font-mono text-xs">push</span>: Run on
                    commits to specified branches
                  </li>
                  <li>
                    <span className="font-mono text-xs">pull_request</span>: Run
                    when PRs are opened or updated
                  </li>
                  <li>
                    <span className="font-mono text-xs">workflow_dispatch</span>
                    : Allow manual runs from GitHub UI
                  </li>
                  <li>
                    <span className="font-mono text-xs">schedule</span>: Run on
              ...
              <div>
                ...
                <div className="mt-2 rounded-lg bg-muted/30 p-3">
                  ...
                  <ul className="ml-4 mt-1 list-disc space-y-1 text-xs">
                    <li>
                      <span className="font-mono">main</span>: Only the main
                      branch
                    </li>
                    <li>
                      <span className="font-mono">develop</span>: Only the
                      develop branch
                    </li>
                    <li>
                      <span className="font-mono">release/*</span>: Any branch
                      starting with "release/"
                    </li>
                    <li>
                      <span className="font-mono">feature/**</span>: All
                      branches in the feature directory
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="rounded-lg border p-4">
                <h4 className="mb-1 font-medium">PR Validation</h4>
  ...
  "branches": ["main"]
              ...
              <div className="rounded-lg border p-4">
                <h4 className="mb-1 font-medium">Continuous Integration</h4>
                <p className="mb-3 text-sm text-muted-foreground">
  ...
  "branches": ["main", "develop"]
              ...
              <div className="rounded-lg border p-4">
                <h4 className="mb-1 font-medium">Release Build</h4>
                <p className="mb-3 text-sm text-muted-foreground">
  ...
  "tags": ["v*.*.*"]
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg border p-4">
                <h4 className="mb-2 font-medium">Path Triggers</h4>
                <p className="text-sm text-muted-foreground">
                  Run workflow only when specific files change. This helps
                  optimize CI/CD resources by only running relevant workflows.
                </p>
                <div className="mt-3">
                  <h5 className="text-sm font-medium">
                    Example: Android-only changes
                  </h5>
                  <pre className="mt-1 overflow-x-auto rounded-md bg-muted/30 p-2 text-xs">
                    <code>
                      {`"triggers": {
  ...
  "paths": ["android/**", "src/**"]
              ...
              <div className="rounded-lg border p-4">
                <h4 className="mb-2 font-medium">Scheduled Builds</h4>
                <p className="text-sm text-muted-foreground">
                  Run workflows on a schedule using cron syntax. Useful for
                  nightly builds or periodic checks.
                </p>
                <div className="mt-3">
                  <h5 className="text-sm font-medium">
  ...
  "cron": "0 2 * * *"
      ...
      <section className="space-y-6" id="build-options">
        <h2 className="text-2xl font-semibold tracking-tight" id="build">
          Build Configuration
        </h2>
        <p className="text-muted-foreground">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border p-4">
              ...
              <div className="space-y-3">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Release builds require signing configuration with keystore
                  credentials.
                  <Link
                    href="/docs/secrets-management#android"
            ...
            <div className="rounded-lg border p-4">
              ...
              <div className="space-y-3">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  iOS builds require certificate and provisioning profile
                  configuration.
                  <Link
                    href="/docs/secrets-management#ios"
                    className="ml-1 inline-flex text-primary hover:underline"
                  >
                    View setup guide
                    <ArrowRight className="ml-1 h-3 w-3" />
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border p-4">
              <h4 className="mb-3 font-medium">Storage Options</h4>
            ...
            <div className="rounded-lg border p-4">
              <h4 className="mb-3 font-medium">Notification Methods</h4>
              ...
              <div className="space-y-2">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Some notification methods require webhook URLs configured as
                  secrets.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4 rounded-lg border p-4">
            <div className="flex items-start gap-2">
              <div className="mt-0.5 flex h-5 w-5 items-center justify-center rounded bg-primary text-xs text-primary-foreground">
                ✓
              </div>
              <div>
                <h4 className="font-medium">Include Static Analysis</h4>
                <p className="mt-1 text-sm text-muted-foreground">
                  Run code quality checks (TypeScript, ESLint, tests) before
                  building. This ensures you don't build on broken code. Toggle
                  this option on or off in the web app interface.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Add custom pre-build and post-build commands to run before or
                  after the main build process. This is useful for additional
                  setup or processing of build artifacts.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="space-y-6">
        <h2
          ...
          id="static-analysis-options"
        >
          Static Analysis Configuration
        </h2>
        <p className="text-muted-foreground">
          Options for configuring code quality checks for your React Native
          project
        </p>

        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-lg border p-5">
            <h3 className="mb-3 font-semibold">Available Quality Checks</h3>
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                <div className="mt-0.5 flex h-5 w-5 items-center justify-center rounded bg-primary text-xs text-primary-foreground">
                  ✓
        ...
        <div className="rounded-lg bg-muted/40 p-5">
          <h3 className="mb-2 font-semibold">Static Analysis Best Practices</h3>
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <h4 className="mb-1 text-sm font-medium">For Pull Requests</h4>
              <ul className="ml-4 list-disc space-y-1 text-sm">
            ...
            <div>
              <h4 className="mb-1 text-sm font-medium">For Performance</h4>
              <ul className="ml-4 list-disc space-y-1 text-sm">
      ...
      <div className="rounded-lg bg-muted p-6">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-2 text-sm">
              The web app provides real-time YAML preview as you configure your
              workflows. It also validates your configuration and highlights
              potential issues before generation.
            </p>
          </div>
        </div>
      </div>
